...
export class ApiConfig {
    ...
    public static getApiUrl() {
        return "http://cmsdev.helpfooter.com/alucard263096/bbsignal/api/";
    }
    public static getUploadPath() {
        return "http://cmsdev.helpfooter.com/alucard263096/bbsignal/upload/";
    }
    public static getFileUploadAPI() {
        return "http://cmsdev.helpfooter.com/alucard263096/bbsignal/fileupload";
    }
    ...
    public static SetLang(langid){
        ApiConfig.LangId=langid;
    }
